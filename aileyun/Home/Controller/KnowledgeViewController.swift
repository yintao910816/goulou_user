...
class KnowledgeViewController: UIViewController {
    ...
    func initUI(){
        ...
        knowledgeL.font = UIFont.init(name: kReguleFont, size: 15)
        ...
        indicateV.frame = CGRect.init(x: SCREEN_WIDTH - 20 - buttonWidth * 4, y: recommendBtn.frame.maxY, width: buttonWidth, height: 3)
        
        
        self.view.addSubview(scrollV)
        scrollV.snp.updateConstraints { (make) in
            make.top.equalTo(knowledgeIV.snp.bottom).offset(20)

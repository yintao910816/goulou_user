...
class ConsultRecordViewController: BaseViewController {
    ...
    func initUI(){
        ...
        allBtn.tag = 0
        allBtn.addTarget(self, action: #selector(ConsultRecordViewController.chooseCategory), for: UIControl.Event.touchUpInside)
        contV.addSubview(allBtn)
        allBtn.frame = CGRect.init(x: 20, y: 0, width: width, height: 40)
        
        notPayBtn.setTitle("未支付", for: .normal)
        notPayBtn.tag = 1
        notPayBtn.addTarget(self, action: #selector(ConsultRecordViewController.chooseCategory), for: UIControl.Event.touchUpInside)
        ...
        waitBtn.tag = 2
        waitBtn.addTarget(self, action: #selector(ConsultRecordViewController.chooseCategory), for: UIControl.Event.touchUpInside)
        ...
        didReplyBtn.tag = 3
        didReplyBtn.addTarget(self, action: #selector(ConsultRecordViewController.chooseCategory), for: UIControl.Event.touchUpInside)
        ...
        backBtn.tag = 4
        backBtn.addTarget(self, action: #selector(ConsultRecordViewController.chooseCategory), for: UIControl.Event.touchUpInside)

...
class ShowShareViewController: BaseViewController, QQApiInterfaceDelegate{
    ...
    override func viewDidLoad() {
        ...
        QQBtn.tag = 0
        QQBtn.addTarget(self, action: #selector(QQshare), for: UIControl.Event.touchUpInside)
        ...
        QQzoneBtn.tag = 1
        QQzoneBtn.addTarget(self, action: #selector(QQshare), for: UIControl.Event.touchUpInside)
        ...
        WeiXinBtn.tag = 2
        WeiXinBtn.addTarget(self, action: #selector(WeiXinShare), for: UIControl.Event.touchUpInside)
        ...
        WXFriendsBtn.tag = 3
        WXFriendsBtn.addTarget(self, action: #selector(WeiXinShare), for: UIControl.Event.touchUpInside)
    }
